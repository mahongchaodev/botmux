...
export const messages: Record<string, string> = {
  ...
  'cmd.echo.usage': 'Usage: send /echo in DM to open the substitute group management card.',
  ...
  'help.echo': '/echo - In DM, open the substitute group management card to enter/exit direct mode, enable/disable substitute, or make the bot leave a group',
