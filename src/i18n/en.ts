...
export const messages: Record<string, string> = {
  ...
  'cmd.echo.usage': 'Usage: send /echo in DM to open the substitute session management card.',
  'cmd.substitute.direct_exit_none': 'No active substitute direct chat is connected right now.',
  'cmd.substitute.direct_exit_ok': '✅ Left substitute direct chat: {chat}',
  'cmd.substitute.direct_list_empty': 'No sessions are available for substitute direct mode. Start or resume a bot session in the target chat or topic first.',
  'cmd.substitute.direct_list_header': 'Available substitute sessions:',
  'cmd.substitute.direct_card_title': 'Substitute direct sessions',
  'cmd.substitute.direct_card_detail_title': 'Substitute session management',
  ...
  'cmd.substitute.direct_field_substitute': 'Substitute',
  'cmd.substitute.direct_field_bot_mention': '@bot',
  'cmd.substitute.direct_bot_mention_on': 'direct',
  'cmd.substitute.direct_bot_mention_off': 'model',
  'cmd.substitute.direct_bot_mention_on_default': 'direct (default)',
  'cmd.substitute.direct_bot_mention_off_default': 'model (default)',
  'cmd.substitute.direct_btn_manage': 'Manage',
  'cmd.substitute.direct_btn_prev_page': 'Previous',
  'cmd.substitute.direct_btn_next_page': 'Next',
  'cmd.substitute.direct_btn_back': 'Back',
  'cmd.substitute.direct_jump_page': 'Page {n}/{total}',
  'cmd.substitute.direct_page_indicator': 'Page {current}/{total}',
  'cmd.substitute.direct_permission_hint': 'Some actions require bot owner/allowedUsers permission; unauthorized buttons are disabled.',
  'cmd.substitute.direct_btn_enable_substitute': 'Enable substitute',
  'cmd.substitute.direct_btn_disable_substitute': 'Disable substitute',
  'cmd.substitute.direct_btn_enter': 'Enter direct',
  'cmd.substitute.direct_btn_exit': 'Exit direct',
  'cmd.substitute.direct_btn_enable_bot_mention': 'Forward @bot',
  'cmd.substitute.direct_btn_disable_bot_mention': 'Do not forward @bot',
  ...
  'cmd.substitute.direct_leave_group_confirm_text': 'Make the bot leave "{chat}"? After leaving, /echo will no longer show this group.',
  'cmd.substitute.direct_not_invoker': 'This substitute direct card belongs to someone else. Send /echo in DM to open your own card.',
  ...
  'cmd.substitute.direct_bot_mention_updated_on': '✅ @bot forwarding is enabled for this session.',
  'cmd.substitute.direct_bot_mention_updated_off': '✅ @bot forwarding is disabled for this session.',
  ...
  'substitute.direct.dm': 'Substitute direct message from "{chat}" (@{target}):\n{content}\n\nReply in this DM and I will forward it back to that group. Send /echo to manage direct mode.',
  ...
  'substitute.direct.non_text_fallback': 'non-text',
  'substitute.direct.unsupported_dm': '⚠️ Substitute direct currently supports text/rich-text messages only.',
  'substitute.direct.no_open_id': '⚠️ Substitute direct requires a target open_id. Re-save the substitute target in Dashboard with an email or ou_ open_id.',
  ...
  'help.heading_substitute': '🪞 Substitute mode:',
  'help.echo': '/echo - In DM, open the substitute session management card to choose a chat or topic session for direct mode and manage substitute toggles',
  'help.substitute_config': 'Dashboard Bot Settings → Substitute mode - configure targets and disclosure; enter direct mode from DM /echo',
