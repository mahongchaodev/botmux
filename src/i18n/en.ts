...
export const messages: Record<string, string> = {
  ...
  'cmd.substitute.direct_list_empty': 'No group chats are available for substitute direct mode. Make sure this bot is still in the target regular group.',
  'cmd.substitute.direct_list_header': 'Available substitute chats:',
  'cmd.substitute.direct_card_title': 'Substitute direct chats',
  'cmd.substitute.direct_card_detail_title': 'Substitute chat management',
  ...
  'cmd.substitute.intervene_state_active': 'intervention (current context target)',
  'cmd.substitute.intervene_state_on': 'intervention',
  ...
  'cmd.substitute.direct_btn_intervene': 'Enter intervention',
  ...
  'cmd.substitute.direct_list_usage': 'Usage: /substitute enter <chat_id> to enter direct mode; /substitute exit <chat_id> to leave direct mode; /substitute leave-group <chat_id> to make the bot leave that group.',
  ...
  'cmd.substitute.intervene_enter_ok': '✅ Entered substitute intervention chat: {chat}',
  ...
  'substitute.intervene.saved': '✅ Saved as intervention context. It will be injected into the next substitute auto-answer in that group.',
  ...
  'help.substitute': '@bot /substitute [status|on|off] - Show/change substitute trigger for this regular group',
  'help.substitute_exit': '/substitute list; /substitute enter|intervene|exit <chat_id>; /substitute leave-group <chat_id> - In DM, list substitute chats, enter direct/intervention mode, exit, or make the bot leave a group',
  'help.substitute_config': 'Dashboard Bot Settings → Substitute mode - configure targets and disclosure; enter direct mode from DM /substitute list',
