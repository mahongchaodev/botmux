...
export const messages: Record<string, string> = {
  ...
  'help.substitute_exit': '/substitute list; /substitute enter|exit <chat_id>; /substitute leave-group <chat_id> - In DM, list substitute chats, enter/exit direct mode, or make the bot leave a group',
