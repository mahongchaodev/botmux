...
export const messages: Record<string, string> = {
  ...
  'cmd.echo.usage': '用法：在单聊中发送 /echo 打开替身会话管理卡。',
  'cmd.substitute.direct_exit_none': '当前没有正在连接的替身直通会话。',
  'cmd.substitute.direct_exit_ok': '✅ 已退出当前替身直通：{chat}',
  'cmd.substitute.direct_list_empty': '当前没有可进入直通模式的会话。请先在目标群聊或话题中建立 bot 会话。',
  'cmd.substitute.direct_list_header': '可用替身会话：',
  'cmd.substitute.direct_card_title': '替身直通会话',
  'cmd.substitute.direct_card_detail_title': '替身会话管理',
  ...
  'cmd.substitute.direct_field_substitute': '替身',
  'cmd.substitute.direct_field_bot_mention': '@机器人',
  'cmd.substitute.direct_bot_mention_on': '直通',
  'cmd.substitute.direct_bot_mention_off': '自动处理',
  'cmd.substitute.direct_bot_mention_on_default': '直通（默认）',
  'cmd.substitute.direct_bot_mention_off_default': '自动处理（默认）',
  'cmd.substitute.direct_btn_manage': '管理',
  'cmd.substitute.direct_btn_prev_page': '上一页',
  'cmd.substitute.direct_btn_next_page': '下一页',
  'cmd.substitute.direct_btn_back': '返回列表',
  'cmd.substitute.direct_jump_page': '第 {n}/{total} 页',
  'cmd.substitute.direct_page_indicator': '第 {current}/{total} 页',
  'cmd.substitute.direct_permission_hint': '部分操作需要 bot owner/allowedUsers 权限；无权限的按钮已置灰。',
  'cmd.substitute.direct_btn_enable_substitute': '开启替身',
  'cmd.substitute.direct_btn_disable_substitute': '关闭替身',
  'cmd.substitute.direct_btn_enter': '进入直通',
  'cmd.substitute.direct_btn_exit': '退出直通',
  'cmd.substitute.direct_btn_enable_bot_mention': '开启 @机器人直通',
  'cmd.substitute.direct_btn_disable_bot_mention': '关闭 @机器人直通',
  ...
  'cmd.substitute.direct_leave_group_confirm_text': '确认让 bot 退出「{chat}」？退出后 /echo 将不再列出该群。',
  'cmd.substitute.direct_not_invoker': '这张替身直通卡片属于别人，请在单聊里发送 /echo 打开自己的卡片。',
  ...
  'cmd.substitute.direct_bot_mention_updated_on': '✅ 已开启当前会话的 @机器人直通。',
  'cmd.substitute.direct_bot_mention_updated_off': '✅ 已关闭当前会话的 @机器人直通。',
  ...
  'substitute.direct.non_text_fallback': '非文本',
  'substitute.direct.unsupported_dm': '⚠️ 当前替身直通只支持文本/富文本消息。',
  'substitute.direct.no_open_id': '⚠️ 替身直通需要目标能解析出 open_id。请在 Dashboard 里用邮箱或 ou_ 重新保存替身对象。',
  ...
  'help.heading_substitute': '🪞 替身模式：',
  'help.echo': '/echo - 单聊中打开替身会话管理卡，可进入/退出直通、开启/关闭替身或让 bot 退出群聊',
  'help.substitute_config': 'Dashboard Bot 配置 → 替身模式 - 配置替身对象和披露方式；直通模式在单聊 /echo 中选择群聊进入',
