...
export const messages: Record<string, string> = {
  ...
  'cmd.substitute.direct_exit_none': '当前没有正在连接的替身直通群聊。',
  'cmd.substitute.direct_exit_ok': '✅ 已退出当前替身直通：{chat}',
  'cmd.substitute.direct_list_empty': '当前没有可进入直通模式的群聊。请确认本 bot 仍在目标普通群里。',
  'cmd.substitute.direct_list_header': '可用替身群聊：',
  'cmd.substitute.direct_card_title': '替身直通群聊',
  'cmd.substitute.direct_card_detail_title': '替身群聊管理',
  'cmd.substitute.direct_state_active': '直通中（当前回复目标）',
  'cmd.substitute.direct_state_on': '直通中',
  'cmd.substitute.direct_state_off': '自动代答',
  'cmd.substitute.intervene_state_active': '干预中（当前补充目标）',
  'cmd.substitute.intervene_state_on': '干预中',
  ...
  'cmd.substitute.direct_btn_intervene': '进入干预',
  ...
  'cmd.substitute.direct_list_usage': '用法：/substitute enter <chat_id> 进入直通；/substitute exit <chat_id> 退出直通；/substitute leave-group <chat_id> 让 bot 直接退出该群。',
  'cmd.substitute.direct_bad_chat': '未找到该群，或该群不是本 bot 所在的普通群。',
  'cmd.substitute.direct_enter_ok': '✅ 已进入替身直通：{chat}',
  'cmd.substitute.intervene_enter_ok': '✅ 已进入替身干预：{chat}',
  ...
  'substitute.intervene.saved': '✅ 已记录为干预补充，会在下一次该群替身自动代答时注入上下文。',
  ...
  'help.substitute': '@机器人 /substitute [status|on|off] - 查看/切换当前普通群替身触发开关',
  'help.substitute_exit': '/substitute list；/substitute enter|intervene|exit <chat_id>；/substitute leave-group <chat_id> - 单聊中列出替身群聊、进入直通/干预/退出，或让 bot 直接退群',
  'help.substitute_config': 'Dashboard Bot 配置 → 替身模式 - 配置替身对象和披露方式；直通模式在单聊 /substitute list 中选择群聊进入',
